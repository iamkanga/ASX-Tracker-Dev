...
// Add event listener for the new header ASX code buttons toggle
...
if (asxCodeButtonsToggle) {
    asxCodeButtonsToggle.addEventListener('click', (e) => {
        console.log('[HEADER TOGGLE] ASX code buttons toggle clicked!');
        // Prevent the click from falling through to other handlers
        try { e.stopPropagation(); e.preventDefault(); } catch(_) {}

        const currentExpanded = getAsxButtonsExpanded();
        console.log('[HEADER TOGGLE] Current expanded state:', currentExpanded);
        const newExpanded = !currentExpanded;
        console.log('[HEADER TOGGLE] New expanded state:', newExpanded);

        setAsxButtonsExpanded(newExpanded);
        applyAsxButtonsState();

        const actualExpanded = getAsxButtonsExpanded();
        console.log('[HEADER TOGGLE] Actual expanded state after toggle:', actualExpanded);

        // Set the scroll flag
        console.log('[HEADER TOGGLE] Setting __asxToggleWantsScroll = true');
        window.__asxToggleWantsScroll = true;
        ...
        // Update aria states for the new toggle element
        try {
